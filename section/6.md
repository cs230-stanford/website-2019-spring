...
# Hero section
title: Section 6
description: In this section we will (1) do a deep dive into the math of L1 and L2 regularization then (2) go through how you can implement classic regularization methods in code.  
