...
- Classifies prior work into different categories
- Short and clear
- References for the interested reader to dive in for further details

How can this be improved?

- Elaborate more on limitations/benefits of prior work
- Elaborate more on how prior work inspired your work
...
- Describes number of datapoints, format of data, gives an example of a datapoint
- Explains why this dataset is difficult to work on: unbalanced. Other possible reasons why dataset is difficult: occlusion, missing inputs, small dataset etc.
...
- Train/validation/test splits are not mentioned here. Be sure to include this, either in your dataset section or in your methods section!
...
- Model architecture is drawn clearly. Convolutions and maxpool with hyperparameters are shown. 
